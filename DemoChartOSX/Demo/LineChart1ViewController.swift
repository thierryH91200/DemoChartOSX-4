...
open class LineChart1ViewController: DemoBaseViewController
{
    ...
    override open func viewDidLoad()
    {
        ...
        llXAxis.valueTextColor = Color.black
        llXAxis.valueFont = Font.systemFont(ofSize: CGFloat(10.0))
        ...
        llXAxis2.valueFont = Font.systemFont(ofSize: CGFloat(10.0))
...
//        xAxis.nameAxisEnabled = true
        ...
        ll1.valueFont = Font.systemFont(ofSize: CGFloat(10.0))
        
        let ll2 = ChartLimitLine(limit: -30.0, label: "Lower Limit")
        ll2.lineWidth = 4.0
        ll2.lineDashLengths = [5.0, 5.0]
        ll2.labelPosition = .rightBottom
        ll2.valueFont = Font.systemFont(ofSize: CGFloat(10.0))
        ...
        leftAxis.isForceLabelsEnabled = true
...
//        leftAxis.nameAxisEnabled = true
        ...
        let marker = BalloonMarker(color: #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1), font: Font.systemFont(ofSize: CGFloat(12.0)), textColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), insets: NSEdgeInsets(top: 8.0, left: 8.0, bottom: 20.0, right: 8.0))
    ...
    func setDataCount(_ count: Int, range: UInt32)
    {
        ...
        else
        {
            ...
            set1.circleColors = [Color.black]
            set1.lineWidth = 1.0
            set1.circleRadius = 3.0
            set1.isDrawCircleHoleEnabled = false
            set1.valueFont = Font.systemFont(ofSize: CGFloat(9.0))
            set1.formLineDashLengths = [5.0, 2.5]
            set1.formLineWidth = 1.0
            set1.formSize = 15.0
            set1.axisDependency = .left
            
            let beginColor = Color( string : "#00ff0000").cgColor
            let endColor = Color( string : "#ffff0000").cgColor
...
extension CAGradientLayer {
    ...
    func turquoiseColor() -> CAGradientLayer {
        let topColor = Color(red: (15/255.0), green: (118/255.0), blue: (128/255.0), alpha: 1)
        let bottomColor = Color(red: (84/255.0), green: (187/255.0), blue: (187/255.0), alpha: 1)
