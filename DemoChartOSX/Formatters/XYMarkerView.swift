...
open class XYMarkerView: BalloonMarker
{
    ...
    public init(color: NSUIColor, font: NSUIFont, textColor: NSUIColor, insets: NSEdgeInsets, xAxisValueFormatter: IAxisValueFormatter, yAxisValueFormatter :  IAxisValueFormatter)
    {
